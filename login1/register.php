...
<ul>
  ...
  <li><a href="#">Products</a>
       <ul>
	<li><a href="https://ruofftechnologies.com/products/custompcs.html">Custom PCs</a></li>
	<li><a href="https://ruofftechnologies.com/products/quadcopters.html">Quadcopters</a></li>
       </ul>
   </li>
  <li><a href="https://ruofftechnologies.com/contact.html">Contact</a></li>
  <li><a href="https://ruofftechnologies.com/about.html">About</a></li>
</ul>
...
<br>
<div style="margin: 30px; background-color:#cffff;height: 200px; border: 1px solid black; padding:5px; opacity: 0.6; filter: alpha(opacity=60);">
<p style="text-align:center; font-weight:bold; font-size:25px;"> Create a Ruoff Technologies Account </p>
<p style="font-family:sans-serif; text-align:center; font-size:15px; line-height:250%;"> Create an account to track your <br> orders and have a more personalized experience.</p>
</div>
<br>
<form id='login' action='registerscript.php' method='post' accept-charset='UTF-8'>
<fieldset>
...
<input type='submit' name='Register' value='Create' />
 <p style="font-family:sans-serif; text-align:center; font-size:15px; line-height:250%;"> Already Have An Account? <a href="https://ruofftechnologies.com/login1/login.php"> Log In! </a> </p>
</fieldset>
</form>
