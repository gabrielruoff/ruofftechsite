<!DOCTYPE html>
<html>
<title> Purchase a Product - Ruoff Technologies </title>
<style>
ul ul {
    position: absolute;
    display: none;
...
<div style="margin: 30px; background-color:#cffff;height: 300px; border: 1px solid black; padding:0px; opacity: 0.6; filter: alpha(opacity=60);">

<p style="text-align:center; color:black; font-weight:bold; line-height:10%; font-size:40px;" > <u>Place an Order</u> </p>

<p style="text-align:center; color:black; font-weight:bold; font-size:25px;" > Please Choose Which Product You Would Like To Purchase </p>

<a href='/order.php'> <button onMouseOver="this.style.color='#000000'" onMouseOut="this.style.color='#ffffff'" style="float:left; padding:10px; border:none; background:green; margin:35px; color:white; cursor:pointer;"> <span> Buy A Quadcopter </button> </a> <p style="font-weight:bold; display:inline-block; color:black; font-size:30px;"> Or </p> <a href='/buyapcconfig.php'> <button onMouseOver="this.style.color='#000000'" onMouseOut="this.style.color='#ffffff'" style="padding-top:10px; padding-bottom:10px; padding-right:20px; padding-left:20px; border:none; float: right; background:green; margin:35px; color:white; cursor:pointer;"> Buy A PC (Currently Unavailable) </span> </button> </a>
