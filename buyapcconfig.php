<!DOCTYPE html>
<html>
<title> Purchase a PC - Ruoff Technologies </title>
<style>
ul ul {
    position: absolute;
    display: none;
...
<p style="font-family:sans-serif; text-align:center; color:red; font-size:15px; line-height:250%;"> This Service is currently unavailable </p>
</div>
