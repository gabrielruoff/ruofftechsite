<!DOCTYPE html>
<html>
<title> Purchase a Quadcopter - Ruoff Technologies </title>
<style>
ul ul {
    position: absolute;
    display: none;
...
<div style="margin: 30px; background-color:#cffff;height: 900px; border: 1px solid black; padding:0px; opacity: 0.6; filter: alpha(opacity=60);">

<p style="text-align:center; font-weight:bold; font-size:25px;"> Purchase A Custom Quadcopter </p>

<pre>

</pre>

<p style="text-align:center; font-weight:bold; font-size:15px;"> To purchase a quadcopter, please fill out the form below </p>

<pre>

</pre>

<iframe src="https://docs.google.com/forms/d/1eUYVQLbjF1DqzDUlWIvhekjFyuOLui5twUjyXWPywnU/viewform?embedded=true" width="760" height="700" frameborder="0" marginheight="0" marginwidth="0">Loading...</iframe>
